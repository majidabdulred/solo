...
*If you have ay idea or feedback, please comment..
*This program generate random football team name and create random squad.
*Football players are selected according to first 5 team players in 5 league(Premier League,Seria A, BundesLiga Ligue 1, Primera Lig).
*Thank you Hatsy Rei for solving problem of dublicating of players name.
*If you liked it don't forget to give a (+1) like.


 **********************************************
 *                                            *
 * Thank you so much for Code Of Day 25.05.18 *
 *                                            *
 **********************************************
...
void playerGen()
{
    ...
    string def[]={"Ramos","Puyol","Pique","Raul Albiol","Vermaelen","Skrtel","Van Dijk","Lovren","Diego Godin","Filipe Luis",
                  ...
                  "Kalidou Koulibaly","Aleksandr Kolarov","Fecerico Fazio","Kostas Manolas","Juan Jesus","Stefan Radu","Stefan de Vrij",
   ...
   string mid[]={"Kevin De Bruyne","Leroy Sane","Ilkay Gundogan","David Silva","Yaya Toure","Raheem Sterling","Nemanja Matic","Juan Mata",
                  ...
                  "Yevhen Konoplyanka","Leon Goretzka","Kevin Vogt","Serge Gnabry","Kerem Demirbay","Nadiem Amiri","Christian Pulisic","Mario Götze",
...
for (int i = 0; i < 50; i++) 
    {
        ...
        swap(mid[rand()%108],mid[rand()%108]);      // for preventing duplication footballer...
...
for(int i=0;i<4;i++)
    {
        cout<<"-"<<mid[rand()%54]<<endl;    ///Generating Midfield position///
    }
...
void TeamGen()
    ...
    string post[]={" F.C"," Istanbul"," Defender"," S.K"," A.C"," Club"," Futebol Club",
                   " United"," Athletic"," Juniors"," Boys"," 09"," Sport"," London",
                   " Munich"," Kiev"," Spartans"," Rovers"," Idman Yurdu"," Force"};
    
    cout<<"Your team is: "<<pre[rand()%18]<<core[rand()%12]<<core1[rand()%15]<<post[rand()%21];
}
